  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>52/186</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>51/178</span>
      </div>
    </div>
  </div>
...
754
755
756</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cstat-no" title="statement not covered" >    const rows = [];</span>
    ...
    Object.keys(schema.fields).forEach(<span class="fstat-no" title="function not covered" >(k) =&gt; {</span>
...
&nbsp;
    this._driver.execute_definition_query(query, <span class="fstat-no" title="function not covered" >(err, result) =&gt; {</span>
      if (err) {
...
&nbsp;
  alter_table(operation, fieldname, type, callback) {
    const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
    const tableName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
    if (operation === 'ALTER') <span class="cstat-no" title="statement not covered" >type = util.format('TYPE %s', type);</span>
...
&nbsp;
  _drop_table(tableName, callback) {
    ...
    this._driver.execute_definition_query(query, <span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
      if (err) {
...
<span class="cstat-no" title="statement not covered" >    const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span></span>
    const tableName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
...
&nbsp;
    ...
    this.drop_mviews(mviews, <span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
      if (err) {
        callback(err);
        return;
      }<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" >    if (this._es_builder) {</span>
      const <span class="cstat-no" title="statement not covered" >indexName = `${this._properties.keyspace}_${this._properties.table_name}`;</span>
      this._es_builder.delete_index(indexName, <span class="fstat-no" title="function not covered" >() =&gt; </span>{
        this.drop_table(materializedViews, <span class="fstat-no" title="function not covered" >(err1) =&gt; {</span>
          if (err1) {
            callback(err1);
            return;
          }<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" >    const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span></span>
    const tableName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
    async.eachSeries(indexes, <span class="fstat-no" title="function not covered" >(idx, next) =&gt; {</span>
      const query = <span class="cstat-no" title="statement not covered" >this._create_index_query(tableName, idx);</span>
      this._driver.execute_definition_query(query, <span class="fstat-no" title="function not covered" >(err, result) =&gt; {</span>
        if (err) <span class="cstat-no" title="statement not covered" >next(buildError('model.tablecreation.dbindexcreate', err));</span>
...
&nbsp;
    if (Object.keys(customIndex.options).length &gt; 0) {
      query += ' WITH OPTIONS = {';
      Object.keys(customIndex.options).forEach(<span class="fstat-no" title="function not covered" >(key) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >    const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span></span>
    const tableName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
    async.eachSeries(customIndexes, <span class="fstat-no" title="function not covered" >(idx, next) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >    async.each(indexes, <span class="fstat-no" title="function not covered" >(idx, next) =&gt; {</span></span>
      ...
      if (err) <span class="cstat-no" title="statement not covered" >callback(buildError('model.tablecreation.dbindexdrop', err));</span>
...
&nbsp;
    for (let k = 0; k &lt; viewSchema.select.length; k++) {
      if (viewSchema.select[k] === '*') <span class="cstat-no" title="statement not covered" >rows.push(util.format('%s', viewSchema.select[k]));</span>
...
<span class="cstat-no" title="statement not covered" >    const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span></span>
    const tableName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
    async.eachSeries(Object.keys(materializedViews), <span class="fstat-no" title="function not covered" >(viewName, next) =&gt; {</span>
      ...
      this._driver.execute_definition_query(query, <span class="fstat-no" title="function not covered" >(err, result) =&gt; {</span>
        if (err) <span class="cstat-no" title="statement not covered" >next(buildError('model.tablecreation.matviewcreate', err));</span>
        else <span class="cstat-no" title="statement not covered" >next(null, result);</span>
      });
    }, callback);
  },
...
<span class="cstat-no" title="statement not covered" >    async.each(mviews, <span class="fstat-no" title="function not covered" >(view, next) =&gt; {</span></span>
      ...
      if (err) <span class="cstat-no" title="statement not covered" >callback(buildError('model.tablecreation.matviewdrop', err));</span>
      else <span class="cstat-no" title="statement not covered" >callback();</span>
    });
  },
&nbsp;
  _apply_alter_operations(alterOperations, dbSchema, normalizedModelSchema, normalizedDBSchema, callback) {
<span class="cstat-no" title="statement not covered" >    // it should create/drop indexes/custom_indexes/materialized_views that are added/removed in model schema</span>
...
<span class="cstat-no" title="statement not covered" >    const removedIndexNames = [];</span>
    removedIndexes.forEach(<span class="fstat-no" title="function not covered" >(removedIndex) =&gt; {</span>
      removedIndexNames.push(dbSchema.index_names[removedIndex]);
    });
&nbsp;
    const <span class="cstat-no" title="statement not covered" >addedCustomIndexes = _</span>.filter(
      normalizedModelSchema.custom_indexes,
<span class="fstat-no" title="function not covered" >      (obj) =&gt; (!_.find(normalizedDBSchema.custom_indexes, obj)),</span>
    );
    const <span class="cstat-no" title="statement not covered" >removedCustomIndexes = _</span>.filter(
      normalizedDBSchema.custom_indexes,
<span class="fstat-no" title="function not covered" >      (obj) =&gt; (!_.find(normalizedModelSchema.custom_indexes, obj)),</span>
    );
    removedCustomIndexes.forEach(<span class="fstat-no" title="function not covered" >(removedIndex) =&gt; {</span>
      removedIndexNames.push(dbSchema.index_names[objectHash(removedIndex)]);
    });
&nbsp;
    const <span class="cstat-no" title="statement not covered" >addedMaterializedViewsNames = _</span>.filter(
      Object.keys(normalizedModelSchema.materialized_views),
<span class="fstat-no" title="function not covered" >      (viewName) =&gt; (!_.isEqual(</span>
        normalizedDBSchema.materialized_views[viewName],
        normalizedModelSchema.materialized_views[viewName],
      )),
    );
&nbsp;
    const <span class="cstat-no" title="statement not covered" >removedMaterializedViewNames = _</span>.filter(
...
<span class="cstat-no" title="statement not covered" >    const addedMaterializedViews = {};</span>
    addedMaterializedViewsNames.forEach(<span class="fstat-no" title="function not covered" >(viewName) =&gt; {</span>
...
&nbsp;
    this.drop_mviews(removedMaterializedViewNames, <span class="fstat-no" title="function not covered" >(err2) =&gt; {</span>
      if (err2) {
        callback(err2);
        return;
      }<span class="cstat-no" title="statement not covered" ></span>
...
&nbsp;
      ...
      this.drop_indexes(removedIndexNames, <span class="fstat-no" title="function not covered" >(err3) =&gt; {</span>
        if (err3) {
          callback(err3);
          return;
        }<span class="cstat-no" title="statement not covered" ></span>
&nbsp;
        ...
        async.eachSeries(alterOperations, <span class="fstat-no" title="function not covered" >(alterOperation, next) =&gt; {</span>
...
&nbsp;
          ...
          this.create_indexes(addedIndexes, <span class="fstat-no" title="function not covered" >(err5) =&gt; {</span>
            if (err5) {
              callback(err5);
              return;
            }<span class="cstat-no" title="statement not covered" ></span>
&nbsp;
            ...
            // eslint-disable-next-line max-nested-callbacks
            this.create_custom_indexes(addedCustomIndexes, <span class="fstat-no" title="function not covered" >(err6) =&gt; {</span>
              if (err6) {
                callback(err6);
                return;
              }<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" >    let droppedFields = false;</span>
    async.eachSeries(differences, <span class="fstat-no" title="function not covered" >(diff, next) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >          if (normalizedDBSchema.key[0].includes(fieldName) || normalizedDBSchema.key.indexOf(fieldName) &gt; 0) {</span>
            ...
            next();
          }<span class="cstat-no" title="statement not covered" > else <span class="cstat-no" title="statement not covered" >if (diff.lhs === 'int' &amp;&amp; diff.rhs === 'varint') {</span></span>
            // alter field type possible
            const message = <span class="cstat-no" title="statement not covered" >util.format(</span>
              'Schema for table "%s" has new type for field "%s", are you sure you want to alter to update the field type?',
              tableName,
            ...
            next();
          }<span class="cstat-no" title="statement not covered" > else if (diff.lhs === 'timeuuid' &amp;&amp; diff.rhs === 'uuid') {</span>
            // alter field type possible
            const message = <span class="cstat-no" title="statement not covered" >util.format(</span>
              'Schema for table "%s" has new type for field "%s", are you sure you want to alter to update the field type?',
              tableName,
...
&nbsp;
      next();
    }<span class="cstat-no" title="statement not covered" >, <span class="fstat-no" title="function not covered" >(err) =&gt; {</span></span>
      if (err) {
        callback(err);
        return;
      }<span class="cstat-no" title="statement not covered" ></span>
      if (droppedFields &amp;&amp; this._es_builder) {
        const <span class="cstat-no" title="statement not covered" >indexName = `${properties.keyspace}_${properties.table_name}`;</span>
        this._es_builder.delete_index(indexName, <span class="fstat-no" title="function not covered" >() =&gt; </span>{
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Feb 03 2018 12:26:19 GMT+0600 (+06)
</div>
</div>
