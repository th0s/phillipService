...
JanusGraphBuilder.prototype = {
  create_graph(graphName, callback) {
    ...
    `;
    const <span class="cstat-no" title="statement not covered" >bindings = {</span>
    ...
    this._client.execute(script, bindings, <span class="fstat-no" title="function not covered" >(err, results) =&gt; {</span>
      if (err) {
        callback(err);
        return;
