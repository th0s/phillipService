  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>221/263</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">83.91% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>219/261</span>
      </div>
    </div>
  </div>
...
1131
1132
1133</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">80048x</span>
...
&nbsp;
  ...
  if (process.env.NODE_ENV === 'production') <span class="cstat-no" title="statement not covered" >migration = 'safe';</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (migration === 'alter') {</span>
      ...
      if (_.isEqual(normalizedModelSchema.key, normalizedDBSchema.key) &amp;&amp;
        ...
        tableBuilder.init_alter_operations(modelSchema, dbSchema, normalizedModelSchema, normalizedDBSchema, <span class="fstat-no" title="function not covered" >(err1) =&gt; {</span>
...
&nbsp;
  if (this.is_table_ready()) {
    ...
    this.init(<span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
      if (err) {
        callback(err);
        return;
      }<span class="cstat-no" title="statement not covered" ></span>
...
&nbsp;
  if (options.allow_filtering) <span class="cstat-no" title="statement not covered" >query += ' ALLOW FILTERING;';</span>
  else query += ';';
&nbsp;
...
BaseModel.findOne = function f(queryObject, options, callback) {
  ...
  if (typeof callback !== 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!options.return_query) {</span>
    throw (buildError('model.find.cberror'));
  }
&nbsp;
  queryObject.$limit = 1;
...
&nbsp;
  options = _.defaultsDeep(options, defaults);
&nbsp;
  if (typeof schema.before_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.before_update(queryObject, updateValues, options) === false) {</span>
...
&nbsp;
  ...
  if (options.ttl) <span class="cstat-no" title="statement not covered" >query += util.format(' USING TTL %s', options.ttl);</span>
  query += ' SET %s %s';
  try {
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: finalParams,
      after_hook: () =&gt; {
        if (typeof schema.after_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_update(queryObject, updateValues, options) === false) {</span>
...
&nbsp;
  options = _.defaultsDeep(options, defaults);
&nbsp;
  if (typeof schema.before_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.before_delete(queryObject, options) === false) {</span>
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: queryParams,
      after_hook: () =&gt; {
        if (typeof schema.after_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_delete(queryObject, options) === false) {</span>
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: queryParams,
      after_hook: () =&gt; {
        if (typeof schema.after_save === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_save(this, options) === false) {</span>
