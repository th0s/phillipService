...
CassandraClient.bind = (options, cb) =&gt; {
  ...
  CassandraClient.orm.initAsync()
    ...
    .catch(<span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
      if (cb &amp;&amp; _.isArray(err) &amp;&amp; err.length &gt; 0) <span class="cstat-no" title="statement not covered" >cb(err[0]);</span>
...
&nbsp;
CassandraClient.uuidFromBuffer = <span class="fstat-no" title="function not covered" >(buf) =&gt; (new cql.types.Uuid(buf));</span>
&nbsp;
...
&nbsp;
CassandraClient.timeuuidFromBuffer = <span class="fstat-no" title="function not covered" >(buf) =&gt; (new cql.types.TimeUuid(buf));</span>
&nbsp;
