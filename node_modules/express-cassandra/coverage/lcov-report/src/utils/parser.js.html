  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>111/127</span>
      </div>
      <div class='fl pad1y space-right2'>
...
712
713
714</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40268x</span>
<span class="cline-any cline-yes">40268x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40267x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40166x</span>
<span class="cline-any cline-yes">40166x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40153x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >  let type = '';</span>
  if (diff.path.length &gt; 1) {
    ...
    type = diff.rhs.type;
    if (diff.rhs.typeDef) <span class="cstat-no" title="statement not covered" >type += diff.rhs.typeDef;</span>
  }
  return type;
};
&nbsp;
...
&nbsp;
  if ($replace) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (fieldType === 'map') {
...
&nbsp;
  const errorHappened = Object.keys(updateValues).some((fieldName) =&gt; {
    if (schema.fields[fieldName] === undefined || schema.fields[fieldName].virtual) <span class="cstat-no" title="statement not covered" >return false;</span>
&nbsp;
    const fieldType = schemer.get_field_type(schema, fieldName);
...
parser.get_limit_clause = function f(queryObject) {
  ...
  Object.keys(queryObject).forEach((k) =&gt; {
    ...
    if (k.toLowerCase() === '$limit') {
      if (typeof queryItem !== 'number') <span class="cstat-no" title="statement not covered" >throw (buildError('model.find.limittype'));</span>
      limit = queryItem;
    }
  });
...
parser.get_select_clause = function f(options) {
  ...
  if (options.select &amp;&amp; _.isArray(options.select) &amp;&amp; options.select.length &gt; 0) {
    ...
    for (let i = 0; i &lt; options.select.length; i++) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (selection.length === 2 || selection.length === 4) {
        let functionClause = util.format('%s("%s")', selection[0], selection[1]);
        if (selection[2]) <span class="cstat-no" title="statement not covered" >functionClause += util.format(' %s', selection[2]);</span>
        if (selection[3]) <span class="cstat-no" title="statement not covered" >functionClause += util.format(' %s', selection[3]);</span>
&nbsp;
