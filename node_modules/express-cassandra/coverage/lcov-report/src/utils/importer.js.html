  ...
  buildTableQueryForDataRow(keyspace, tableInfo, row) {
    ...
    params = _.map(params, (param) =&gt; {
      if (_.isPlainObject(param)) {
        ...
        const <span class="cstat-no" title="statement not covered" >omittedParams = _</span>.omitBy(param, <span class="fstat-no" title="function not covered" >(item) =&gt; (item === null));</span>
        Object.keys(omittedParams).forEach(<span class="fstat-no" title="function not covered" >(key) =&gt; {</span>
